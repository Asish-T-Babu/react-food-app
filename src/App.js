...
const restaurants = [
  {
    ...
    "analytics": {
      "context": "seo-data-6278cbbe-c4c0-4240-9bfa-0d8bc29a7384"
    },
    "cta": {
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-01-23 05:59:00",
        "opened": true
      },
      "badges": {
        "textExtendedBadges": [
  ...
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-01-23 02:45:00",
        "opened": true
      },
      "badges": {
        "textExtendedBadges": [
...
// props is an object
// we can destructure the props like, instead of righting the props as argument for component  they will write {with the keys} - > if i am passing myname and age as argument for a component, in component i can access the name and age using props.'variable_name' ((props)=>{}) if i am taking argument as props in the function or i can directly acccess  the value using the  variable_name if i am taking destructured props as argument c ({name, age}) = > {} in the argument of the function
...
// props - properties, properties are something which you can pass to a component 
